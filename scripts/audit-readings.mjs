...
const VERIFIED_OK = new Set([
  ...
  'cl-068', // 手如柔荑 荑=ㄊㄧˊ（簡編本單字「荑」只收 ㄧˊ 除草義、無「柔荑」詞條；詩經嫩芽義退修訂本作 ㄊㄧˊ）
  ...
  // 2026-06-14 簡編本權威重審舊題（reaudit-concised.mjs 忽略白名單跑全庫）糾正後，
  // 因 text 為語境句、moedict 退階層仍誤報，加白名單（已回簡編本詞條覆核）：
  'tk-204', // 態度輕佻 佻=ㄊㄧㄠˊ（簡編本「輕佻」ㄑㄧㄥ ㄊㄧㄠˊ；moedict 把單字 ㄊㄧㄠ 當第一正音屬退階）
  'cl-109'  // 早生華髮 華=ㄏㄨㄚˊ（簡編本「華髮」ㄏㄨㄚˊ ㄈㄚˇ，dictView ID=20116 確認；moedict 把 ㄏㄨㄚ 當第一正音屬退階）
]);
