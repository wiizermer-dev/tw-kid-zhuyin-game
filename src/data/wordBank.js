...
export const enWords = [
    ...
    { char: "蚊子", target: "蚊", pinyin: "ㄨㄣˊ", english: "Mosquito" },
    { char: "吻別", target: "吻", pinyin: "ㄨㄣˇ", english: "Kiss" },
    { char: "穩定", target: "穩", pinyin: "ㄨㄣˇ", english: "Stable" },
    { char: "溫柔", target: "溫", pinyin: "ㄨㄣ", english: "Gentle" },
    { char: "雲朵", target: "雲", pinyin: "ㄩㄣˊ", english: "Cloud" },
    { char: "運動", target: "運", pinyin: "ㄩㄣˋ", english: "Sports" },
    { char: "軍人", target: "軍", pinyin: "ㄐㄩㄣ", english: "Soldier" },
    { char: "均勻", target: "均", pinyin: "ㄐㄩㄣ", english: "Even" },
    { char: "菌類", target: "菌", pinyin: "ㄐㄩㄣˋ", english: "Fungi" },
    ...
    { char: "新年", target: "新", pinyin: "ㄒㄧㄣ", english: "New Year" },
    { char: "心情", target: "心", pinyin: "ㄒㄧㄣ", english: "Mood" },
    { char: "親人", target: "親", pinyin: "ㄑㄧㄣ", english: "Relative" },
    { char: "勤勞", target: "勤", pinyin: "ㄑㄧㄣˊ", english: "Diligent" },
    { char: "琴弦", target: "琴", pinyin: "ㄑㄧㄣˊ", english: "Piano" },
    { char: "貧窮", target: "貧", pinyin: "ㄆㄧㄣˊ", english: "Poor" },
    { char: "頻繁", target: "頻", pinyin: "ㄆㄧㄣˊ", english: "Frequent" },
    { char: "拼命", target: "拼", pinyin: "ㄆㄧㄣ", english: "Desperately" },
    { char: "賓客", target: "賓", pinyin: "ㄅㄧㄣ", english: "Guest" },
    { char: "民眾", target: "民", pinyin: "ㄇㄧㄣˊ", english: "People" },
    { char: "敏感", target: "敏", pinyin: "ㄇㄧㄣˇ", english: "Sensitive" },
    { char: "臨時", target: "臨", pinyin: "ㄌㄧㄣˊ", english: "Temporary" },
    { char: "鄰近", target: "鄰", pinyin: "ㄌㄧㄣˊ", english: "Nearby" },
    { char: "金錢", target: "金", pinyin: "ㄐㄧㄣ", english: "Money" },
    { char: "謹慎", target: "謹", pinyin: "ㄐㄧㄣˇ", english: "Cautious" },
    { char: "禁止", target: "禁", pinyin: "ㄐㄧㄣˋ", english: "Forbid" },
    { char: "盡力", target: "盡", pinyin: "ㄐㄧㄣˋ", english: "Do one's best" },
    { char: "錦繡", target: "錦", pinyin: "ㄐㄧㄣˇ", english: "Splendid" },
    { char: "勁敵", target: "勁", pinyin: "ㄐㄧㄣˋ", english: "Strong rival" },
    { char: "筋骨", target: "筋", pinyin: "ㄐㄧㄣ", english: "Tendon" }
];
...
export const engWords = [
    ...
    { char: "東西", target: "東", pinyin: "ㄉㄨㄥ", english: "Thing" },
    { char: "公平", target: "公", pinyin: "ㄍㄨㄥ", english: "Fair" },
    { char: "功課", target: "功", pinyin: "ㄍㄨㄥ", english: "Homework" },
    { char: "蟲子", target: "蟲", pinyin: "ㄔㄨㄥˊ", english: "Insect" },
    { char: "重要", target: "重", pinyin: "ㄓㄨㄥˋ", english: "Important" },
    { char: "中間", target: "中", pinyin: "ㄓㄨㄥ", english: "Middle" },
    { char: "終點", target: "終", pinyin: "ㄓㄨㄥ", english: "Endpoint" },
    { char: "洪水", target: "洪", pinyin: "ㄏㄨㄥˊ", english: "Flood" },
    { char: "紅色", target: "紅", pinyin: "ㄏㄨㄥˊ", english: "Red" },
    { char: "送禮", target: "送", pinyin: "ㄙㄨㄥˋ", english: "Give gift" },
    { char: "通知", target: "通", pinyin: "ㄊㄨㄥ", english: "Notify" },
    { char: "統一", target: "統", pinyin: "ㄊㄨㄥˇ", english: "Unify" },
    { char: "痛苦", target: "痛", pinyin: "ㄊㄨㄥˋ", english: "Pain" },
    ...
    { char: "清楚", target: "清", pinyin: "ㄑㄧㄥ", english: "Clear" },
    { char: "青蛙", target: "青", pinyin: "ㄑㄧㄥ", english: "Frog" },
    { char: "輕鬆", target: "輕", pinyin: "ㄑㄧㄥ", english: "Relaxed" },
    { char: "情況", target: "情", pinyin: "ㄑㄧㄥˊ", english: "Situation" },
    { char: "請假", target: "請", pinyin: "ㄑㄧㄥˇ", english: "Ask for leave" },
    { char: "慶祝", target: "慶", pinyin: "ㄑㄧㄥˋ", english: "Celebrate" },
    { char: "平安", target: "平", pinyin: "ㄆㄧㄥˊ", english: "Safe" },
    { char: "評分", target: "評", pinyin: "ㄆㄧㄥˊ", english: "Grade" },
    { char: "兵隊", target: "兵", pinyin: "ㄅㄧㄥ", english: "Soldier" },
    { char: "冰淇淋", target: "冰", pinyin: "ㄅㄧㄥ", english: "Ice cream" },
    { char: "並且", target: "並", pinyin: "ㄅㄧㄥˋ", english: "And" },
    { char: "命令", target: "命", pinyin: "ㄇㄧㄥˋ", english: "Order" },
    { char: "寧靜", target: "寧", pinyin: "ㄋㄧㄥˊ", english: "Peaceful" },
    { char: "領導", target: "領", pinyin: "ㄌㄧㄥˇ", english: "Lead" },
    { char: "另外", target: "另", pinyin: "ㄌㄧㄥˋ", english: "Another" },
    { char: "頂端", target: "頂", pinyin: "ㄉㄧㄥˇ", english: "Top" },
    { char: "訂閱", target: "訂", pinyin: "ㄉㄧㄥˋ", english: "Subscribe" },
    { char: "亭子", target: "亭", pinyin: "ㄊㄧㄥˊ", english: "Pavilion" },
    { char: "停車", target: "停", pinyin: "ㄊㄧㄥˊ", english: "Park" },
    { char: "挺直", target: "挺", pinyin: "ㄊㄧㄥˇ", english: "Straight" },
    { char: "形狀", target: "形", pinyin: "ㄒㄧㄥˊ", english: "Shape" },
    { char: "刑罰", target: "刑", pinyin: "ㄒㄧㄥˊ", english: "Punishment" },
    { char: "興奮", target: "興", pinyin: "ㄒㄧㄥˋ", english: "Excited" },
    { char: "幸福", target: "幸", pinyin: "ㄒㄧㄥˋ", english: "Happy" }
];
...
export const hardEnWords = [
    ...
    { char: "莘莘學子", target: "莘", pinyin: "ㄕㄣ", wrong: "ㄒㄧㄣ", english: "Many students" },
    { char: "參差不齊", target: "參", pinyin: "ㄘㄣ", wrong: "ㄘㄢ", english: "Uneven" },
    ...
    { char: "溫文儒雅", target: "溫", pinyin: "ㄨㄣ", english: "Gentle" },
    { char: "文質彬彬", target: "文", pinyin: "ㄨㄣˊ", english: "Refined" },
    { char: "循循善誘", target: "循", pinyin: "ㄒㄩㄣˊ", english: "Patient guidance" },
    { char: "勤勉不懈", target: "勤", pinyin: "ㄑㄧㄣˊ", english: "Diligent" },
    { char: "慎重其事", target: "慎", pinyin: "ㄕㄣˋ", english: "Careful" },
    { char: "眾志成城", target: "眾", pinyin: "ㄓㄨㄥˋ", wrong: "ㄓㄨㄥ", english: "United" },
    { char: "忠心耿耿", target: "忠", pinyin: "ㄓㄨㄥ", english: "Loyal" },
    { char: "中流砥柱", target: "中", pinyin: "ㄓㄨㄥ", english: "Mainstay" },
    { char: "振奮人心", target: "振", pinyin: "ㄓㄣˋ", english: "Inspiring" },
    { char: "斤斤計較", target: "斤", pinyin: "ㄐㄧㄣ", english: "Petty" },
    { char: "津津有味", target: "津", pinyin: "ㄐㄧㄣ", english: "With relish" },
    { char: "謹小慎微", target: "謹", pinyin: "ㄐㄧㄣˇ", english: "Overcautious" },
    { char: "盡善盡美", target: "盡", pinyin: "ㄐㄧㄣˋ", english: "Perfect" },
    { char: "林林總總", target: "林", pinyin: "ㄌㄧㄣˊ", english: "Various" },
    { char: "臨危不亂", target: "臨", pinyin: "ㄌㄧㄣˊ", english: "Calm in crisis" },
    { char: "賓至如歸", target: "賓", pinyin: "ㄅㄧㄣ", english: "Feel at home" },
    { char: "殷切期盼", target: "殷", pinyin: "ㄧㄣ", english: "Earnestly hope" },
    { char: "音容宛在", target: "音", pinyin: "ㄧㄣ", english: "Voice and face" },
    { char: "親密無間", target: "親", pinyin: "ㄑㄧㄣ", english: "Intimate" },
    { char: "勤學苦練", target: "勤", pinyin: "ㄑㄧㄣˊ", english: "Study hard" },
    { char: "沁人心脾", target: "沁", pinyin: "ㄑㄧㄣˋ", english: "Refreshing" },
    { char: "前因後果", target: "因", pinyin: "ㄧㄣ", english: "Cause and effect" },
    { char: "引人入勝", target: "引", pinyin: "ㄧㄣˇ", english: "Fascinating" },
    { char: "印象深刻", target: "印", pinyin: "ㄧㄣˋ", english: "Impressive" },
...
export const hardEngWords = [
    ...
    // 成語 (Idioms)
    { char: "屏氣凝神", target: "屏", pinyin: "ㄅㄧㄥˇ", wrong: "ㄆㄧㄥˊ", english: "Hold breath" },
    { char: "鵬程萬里", target: "鵬", pinyin: "ㄆㄥˊ", english: "Bright future" },
    { char: "興高采烈", target: "興", pinyin: "ㄒㄧㄥˋ", english: "Elated" },
    { char: "驚鴻一瞥", target: "驚", pinyin: "ㄐㄧㄥ", english: "Glance" },
    { char: "兢兢業業", target: "兢", pinyin: "ㄐㄧㄥ", wrong: "ㄐㄧㄣˋ", english: "Cautious" },
    ...
    { char: "平步青雲", target: "平", pinyin: "ㄆㄧㄥˊ", english: "Rapid rise" },
    { char: "並駕齊驅", target: "並", pinyin: "ㄅㄧㄥˋ", english: "Neck and neck" },
    { char: "冰清玉潔", target: "冰", pinyin: "ㄅㄧㄥ", english: "Pure" },
    { char: "明察秋毫", target: "明", pinyin: "ㄇㄧㄥˊ", english: "Perceptive" },
    { char: "名副其實", target: "名", pinyin: "ㄇㄧㄥˊ", english: "Worthy of name" },
    { char: "命運多舛", target: "命", pinyin: "ㄇㄧㄥˋ", english: "Unfortunate" },
    { char: "寧靜致遠", target: "寧", pinyin: "ㄋㄧㄥˊ", english: "Peace achieves goals" },
    { char: "靈機一動", target: "靈", pinyin: "ㄌㄧㄥˊ", english: "Sudden idea" },
    { char: "零零星星", target: "零", pinyin: "ㄌㄧㄥˊ", english: "Scattered" },
    { char: "頂天立地", target: "頂", pinyin: "ㄉㄧㄥˇ", english: "Great man" },
    { char: "定於一尊", target: "定", pinyin: "ㄉㄧㄥˋ", english: "Settled" },
    { char: "亭亭玉立", target: "亭", pinyin: "ㄊㄧㄥˊ", english: "Graceful" },
    { char: "挺身而出", target: "挺", pinyin: "ㄊㄧㄥˇ", english: "Stand up" },
    { char: "形形色色", target: "形", pinyin: "ㄒㄧㄥˊ", english: "Various" },
    { char: "星羅棋布", target: "星", pinyin: "ㄒㄧㄥ", english: "Scattered" },
    { char: "興風作浪", target: "興", pinyin: "ㄒㄧㄥ", english: "Stir up trouble" },
    { char: "幸災樂禍", target: "幸", pinyin: "ㄒㄧㄥˋ", english: "Gloat" },
    { char: "清風明月", target: "清", pinyin: "ㄑㄧㄥ", english: "Pure and clear" },
    { char: "輕而易舉", target: "輕", pinyin: "ㄑㄧㄥ", english: "Easy" },
    { char: "情深義重", target: "情", pinyin: "ㄑㄧㄥˊ", english: "Deep affection" },
    { char: "請君入甕", target: "請", pinyin: "ㄑㄧㄥˇ", english: "Trap" },
    { char: "慶賀佳節", target: "慶", pinyin: "ㄑㄧㄥˋ", english: "Celebrate" },
    { char: "平易近人", target: "平", pinyin: "ㄆㄧㄥˊ", english: "Approachable" },
    { char: "評頭論足", target: "評", pinyin: "ㄆㄧㄥˊ", english: "Nitpick" },
    { char: "兵荒馬亂", target: "兵", pinyin: "ㄅㄧㄥ", english: "Chaos" },
    { char: "病入膏肓", target: "病", pinyin: "ㄅㄧㄥˋ", english: "Incurable" },
    { char: "榮華富貴", target: "榮", pinyin: "ㄖㄨㄥˊ", wrong: "ㄌㄨㄥˊ", english: "Wealth" },
    { char: "容光煥發", target: "容", pinyin: "ㄖㄨㄥˊ", wrong: "ㄌㄨㄥˊ", english: "Radiant" },
    { char: "勇往直前", target: "勇", pinyin: "ㄩㄥˇ", english: "Forge ahead" },
    { char: "永垂不朽", target: "永", pinyin: "ㄩㄥˇ", english: "Immortal" },
    { char: "用心良苦", target: "用", pinyin: "ㄩㄥˋ", english: "Well-intentioned" },
    { char: "迥然不同", target: "迥", pinyin: "ㄐㄩㄥˇ", english: "Completely different" },
    { char: "炯炯有神", target: "炯", pinyin: "ㄐㄩㄥˇ", english: "Bright eyes" },
    { char: "窮途末路", target: "窮", pinyin: "ㄑㄩㄥˊ", english: "Dead end" },
    { char: "公正無私", target: "公", pinyin: "ㄍㄨㄥ", english: "Impartial" },
    { char: "功成名就", target: "功", pinyin: "ㄍㄨㄥ", english: "Successful" },
    { char: "空前絕後", target: "空", pinyin: "ㄎㄨㄥ", english: "Unprecedented" },
    { char: "東山再起", target: "東", pinyin: "ㄉㄨㄥ", english: "Comeback" },
    { char: "冬去春來", target: "冬", pinyin: "ㄉㄨㄥ", english: "Seasons change" },
    { char: "通情達理", target: "通", pinyin: "ㄊㄨㄥ", english: "Reasonable" },
    { char: "統籌全局", target: "統", pinyin: "ㄊㄨㄥˇ", english: "Overall planning" },
    { char: "重蹈覆轍", target: "重", pinyin: "ㄔㄨㄥˊ", wrong: "ㄓㄨㄥˋ", english: "Repeat mistake" },
    { char: "蟲魚鳥獸", target: "蟲", pinyin: "ㄔㄨㄥˊ", english: "All creatures" },
    { char: "中庸之道", target: "中", pinyin: "ㄓㄨㄥ", english: "Moderation" },
    { char: "終身大事", target: "終", pinyin: "ㄓㄨㄥ", english: "Marriage" },
    { char: "洪福齊天", target: "洪", pinyin: "ㄏㄨㄥˊ", english: "Great fortune" },
    { char: "紅顏薄命", target: "紅", pinyin: "ㄏㄨㄥˊ", english: "Beautiful but unlucky" },
    { char: "鬆懈怠慢", target: "鬆", pinyin: "ㄙㄨㄥ", wrong: "ㄙㄨㄣ", english: "Slack off" },
    { char: "送舊迎新", target: "送", pinyin: "ㄙㄨㄥˋ", english: "Farewell old welcome new" },
