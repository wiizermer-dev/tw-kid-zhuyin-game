...
export default [
  {
    id: 'rr-001', text: '饕餮', target: '餮', zhuyin: 'ㄊㄧㄝˋ',
    distractors: ['ㄊㄧㄢˇ', 'ㄓㄢ'],
    meaning: '傳說中貪吃的凶獸，比喻貪婪的人',
    fun: '饕餮唸「ㄊㄠ ㄊㄧㄝˋ」。能唸對的人，吃到飽餐廳都怕你',
    tags: ['生僻字', '美食'], difficulty: 4, era: 'classic'
  },
  {
    id: 'rr-002', text: '魑魅魍魎', target: '魑', zhuyin: 'ㄔ',
    distractors: ['ㄌㄧˊ', 'ㄔˊ'],
    meaning: '各種妖魔鬼怪',
  ...
  {
    id: 'rr-003', text: '齟齬', target: '齬', zhuyin: 'ㄩˇ',
    distractors: ['ㄨˇ', 'ㄧㄚˊ'],
    meaning: '意見不合、互相牴觸',
  ...
  {
    id: 'rr-004', text: '耄耋之年', target: '耋', zhuyin: 'ㄉㄧㄝˊ',
    distractors: ['ㄓˋ', 'ㄌㄠˇ'],
    meaning: '八、九十歲的高齡',
  ...
  {
    id: 'rr-005', text: '彳亍街頭', target: '亍', zhuyin: 'ㄔㄨˋ',
    distractors: ['ㄒㄧㄥˊ', 'ㄔˋ'],
    meaning: '慢步行走、走走停停',
  ...
  {
    id: 'rr-006', text: '醍醐灌頂', target: '醍', zhuyin: 'ㄊㄧˊ',
    distractors: ['ㄕˋ', 'ㄉㄧˇ'],
  ...
  {
    id: 'rr-007', text: '鰥寡孤獨', target: '鰥', zhuyin: 'ㄍㄨㄢ',
    distractors: ['ㄏㄨㄢˊ', 'ㄍㄨㄢˇ'],
    meaning: '泛指沒有依靠的人',
    fun: '鰥是喪妻的男子。魚字旁但跟魚無關，單身狗的古代豪華版寫法',
    tags: ['生僻字', '成語', '大考'], difficulty: 4, era: 'classic'
  },
  {
    id: 'rr-008', text: '罹難', target: '罹', zhuyin: 'ㄌㄧˊ',
    distractors: ['ㄌㄨㄛˊ', 'ㄗㄠ'],
    meaning: '遭遇災禍而死亡',
    fun: '新聞主播必修字。罹患的罹也是這個音',
    tags: ['生僻字', '新聞常錯'], difficulty: 2, era: 'modern'
  },
  {
    id: 'rr-009', text: '贗品', target: '贗', zhuyin: 'ㄧㄢˋ',
    distractors: ['ㄧㄥ', 'ㄨㄟˇ'],
    meaning: '偽造的物品',
  ...
  {
    id: 'rr-010', text: '縝密', target: '縝', zhuyin: 'ㄓㄣˇ',
    distractors: ['ㄕㄣˋ', 'ㄓㄢ'],
    meaning: '細緻周密',
    fun: '邏輯縝密的第一步：不要唸成「慎密」',
    tags: ['生僻字', '大考'], difficulty: 3, era: 'classic'
  },
  {
    id: 'rr-011', text: '步履蹣跚', target: '蹣', zhuyin: 'ㄆㄢˊ',
    distractors: ['ㄇㄢˊ', 'ㄆㄢ'],
    meaning: '走路緩慢搖晃的樣子',
    fun: '蹣唸ㄆㄢˊ不唸ㄇㄢˊ，十個人九個錯的等級',
    tags: ['生僻字', '易讀錯', '成語'], difficulty: 3, era: 'classic'
  },
  {
    id: 'rr-012', text: '顢頇', target: '頇', zhuyin: 'ㄏㄢ',
    distractors: ['ㄍㄢˋ', 'ㄏㄢˋ'],
    meaning: '糊塗而不明事理',
    fun: '顢頇唸「ㄇㄢ ㄏㄢ」。罵官員專用字，政論節目進階詞彙',
    tags: ['生僻字', '新聞常錯'], difficulty: 5, era: 'classic'
  },
  {
    id: 'rr-013', text: '齷齪', target: '齷', zhuyin: 'ㄨㄛˋ',
    distractors: ['ㄨㄛ', 'ㄜˋ'],
    meaning: '骯髒、卑鄙',
    fun: '齷齪唸「ㄨㄛˋ ㄔㄨㄛˋ」，兩個字都是齒字旁，髒到牙齒裡',
    tags: ['生僻字'], difficulty: 4, era: 'classic'
  },
  {
    id: 'rr-014', text: '覬覦', target: '覬', zhuyin: 'ㄐㄧˋ',
    distractors: ['ㄎㄞˇ', 'ㄑㄧˊ'],
    meaning: '非分地希望得到',
  ...
  {
    id: 'rr-015', text: '耆老', target: '耆', zhuyin: 'ㄑㄧˊ',
    distractors: ['ㄕˋ', 'ㄐㄧ'],
    meaning: '六十歲以上德高望重的長者',
    fun: '地方新聞高頻字：「地方耆老表示——」',
    tags: ['生僻字', '新聞常錯'], difficulty: 3, era: 'classic'
  },
  {
    id: 'rr-016', text: '鞭笞', target: '笞', zhuyin: 'ㄔ',
    distractors: ['ㄊㄞˊ', 'ㄓˋ'],
    meaning: '用鞭子或竹板抽打',
  ...
  {
    id: 'rr-017', text: '邂逅', target: '邂', zhuyin: 'ㄒㄧㄝˋ',
    distractors: ['ㄐㄧㄝˇ', 'ㄒㄧㄝ'],
    meaning: '沒有事先約定而偶然相遇',
    fun: '邂逅唸「ㄒㄧㄝˋ ㄏㄡˋ」。在路上偶遇曖昧對象，唸錯字直接出局',
    tags: ['生僻字', '日常'], difficulty: 2, era: 'modern'
  },
  {
    id: 'rr-018', text: '髖關節', target: '髖', zhuyin: 'ㄎㄨㄢ',
    distractors: ['ㄎㄨㄚˋ', 'ㄆㄢˊ'],
    meaning: '連接骨盆與大腿骨的關節',
    fun: '健身教練都唸「ㄎㄨㄚˋ關節」，但正解是ㄎㄨㄢ。深蹲前先蹲好讀音',
    tags: ['生僻字', '日常'], difficulty: 3, era: 'modern'
  },
  {
    id: 'rr-019', text: '蚍蜉撼樹', target: '蚍', zhuyin: 'ㄆㄧˊ',
    distractors: ['ㄅㄧˇ', 'ㄈㄨˊ'],
    meaning: '比喻不自量力',
  ...
  {
    id: 'rr-020', text: '倥傯', target: '傯', zhuyin: 'ㄗㄨㄥˇ',
    distractors: ['ㄘㄨㄥ', 'ㄗㄨㄥˋ'],
    meaning: '事情繁忙急迫',
    fun: '戎馬倥傯唸「ㄎㄨㄥˇ ㄗㄨㄥˇ」。古人的「忙到爆」',
    tags: ['生僻字'], difficulty: 5, era: 'classic'
  },
  {
    id: 'rr-021', text: '髑髏', target: '髑', zhuyin: 'ㄉㄨˊ',
    distractors: ['ㄕㄨˇ', 'ㄌㄨˊ'],
    meaning: '死人的頭骨',
  ...
  {
    id: 'rr-022', text: '璀璨', target: '璀', zhuyin: 'ㄘㄨㄟˇ',
    distractors: ['ㄗㄨㄟˇ', 'ㄘㄨㄟ'],
    meaning: '光彩奪目的樣子',
    fun: '煙火很璀璨，唸對的人生也很璀璨',
    tags: ['生僻字', '日常'], difficulty: 2, era: 'modern'
  },
  {
    id: 'rr-023', text: '痼疾', target: '痼', zhuyin: 'ㄍㄨˋ',
    distractors: ['ㄎㄨˋ', 'ㄍㄨ'],
    meaning: '長期難以治癒的疾病',
  ...
  {
    id: 'rr-024', text: '魁梧', target: '魁', zhuyin: 'ㄎㄨㄟˊ',
    distractors: ['ㄍㄨㄟˇ', 'ㄎㄨㄟˇ'],
    meaning: '身材高大強壯',
    fun: '健身房的成果叫魁梧，唸錯叫尷尬',
    tags: ['生僻字', '日常'], difficulty: 2, era: 'modern'
  },
  {
    id: 'rr-025', text: '饗宴', target: '饗', zhuyin: 'ㄒㄧㄤˇ',
    distractors: ['ㄒㄧㄤ', 'ㄕㄤˇ'],
    meaning: '豐盛的宴席',
    fun: '吃到飽餐廳最愛取名「饗」什麼的，去之前先學會唸',
    tags: ['生僻字', '美食'], difficulty: 2, era: 'modern'
  },
  {
    id: 'rr-026', text: '攫取', target: '攫', zhuyin: 'ㄐㄩㄝˊ',
    distractors: ['ㄏㄨㄛˋ', 'ㄐㄩㄝˋ'],
    meaning: '強力奪取',
    fun: '攫取暴利的攫，財經新聞高頻字',
    tags: ['生僻字', '新聞常錯'], difficulty: 4, era: 'classic'
  },
  {
    id: 'rr-027', text: '抽搐', target: '搐', zhuyin: 'ㄔㄨˋ',
    distractors: ['ㄒㄩˋ', 'ㄔㄨ'],
    meaning: '肌肉不自主地收縮抖動',
    fun: '看到有人唸錯，嘴角不自覺抽搐',
    tags: ['生僻字', '日常'], difficulty: 3, era: 'modern'
  ...
  {
    id: 'rr-028', text: '剎那', target: '剎', zhuyin: 'ㄔㄚˋ',
    distractors: ['ㄕㄚ', 'ㄕㄚˋ'],
    meaning: '極短的時間',
    fun: '剎那唸ㄔㄚˋ，煞車的煞才唸ㄕㄚ。一瞬間的事，錯了就是錯了',
    tags: ['生僻字', '易讀錯', '日常'], difficulty: 2, era: 'classic'
  },
  {
    id: 'rr-029', text: '蜷縮', target: '蜷', zhuyin: 'ㄑㄩㄢˊ',
    distractors: ['ㄐㄩㄢˇ', 'ㄑㄩㄢ'],
    meaning: '身體彎曲縮成一團',
    fun: '冬天棉被裡的標準姿勢。蜷唸ㄑㄩㄢˊ，不是捲',
    tags: ['生僻字', '日常'], difficulty: 3, era: 'modern'
  },
  {
    id: 'rr-030', text: '啜泣', target: '啜', zhuyin: 'ㄔㄨㄛˋ',
    distractors: ['ㄗㄨㄟˇ', 'ㄔㄨㄢˊ'],
    meaning: '抽抽噎噎地哭',
