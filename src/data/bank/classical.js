...
export default [
  ...
  },
  {
    ...
    target: "荑",
    zhuyin: "ㄊㄧˊ",
    distractors: ["ㄉㄧˋ", "ㄊㄧˇ", "ㄕˊ"],
    meaning: "手像初生的嫩芽般柔嫩。出自《詩經‧衛風‧碩人》",
    fun: "柔荑（草木嫩芽）的荑唸ㄊㄧˊ；簡編本單字「荑」只收ㄧˊ（除草義），此詩經嫩芽義退修訂本作ㄊㄧˊ",
    tags: ["古文", "詩經"],
    difficulty: 5,
    era: "classic",
  },
  ...
  },
  {
    ...
    target: "華",
    zhuyin: "ㄏㄨㄚˊ",
    distractors: ["ㄏㄨㄚ", "ㄏㄨㄚˋ", "ㄏㄨㄛˊ"],
    meaning: "早早長出花白頭髮。蘇軾〈念奴嬌〉",
    fun: "簡編本「華髮」收ㄏㄨㄚˊ（同中華的華）；雖義通「花」，但教育部標準音是二聲不是一聲",
    tags: ["宋詞", "破音字", "大考"],
    difficulty: 5,
    era: "classic",
  },
  ...
  },
  {
    ...
    target: "廈",
    zhuyin: "ㄒㄧㄚˋ",
    distractors: ["ㄕㄚˋ", "ㄕㄚ", "ㄒㄧㄚ"],
    meaning: "哪裡能有千萬間大房子。杜甫〈茅屋為秋風所破歌〉",
    fun: "台灣簡編本「大廈」「廈門」的廈都唸ㄒㄧㄚˋ；ㄕㄚˋ是大陸音。杜甫的社會住宅願望",
    tags: ["唐詩", "破音字", "大考"],
    difficulty: 3,
    era: "classic",
  },
