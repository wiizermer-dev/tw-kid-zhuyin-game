...
export default [
  ...
  {
    id: 'cl-006', text: '死生契闊', target: '契', zhuyin: 'ㄑㄧㄝˋ',
    distractors: ['ㄑㄧˋ', 'ㄒㄧㄝˋ'],
    meaning: '生死離合（契闊：聚散）。出自《詩經・邶風》',
    fun: '教育部辭典「契闊」唸ㄑㄧㄝˋ ㄎㄨㄛˋ，自信唸ㄑㄧˋ的人最容易中招',
