...
export default [
  ...
  },
  {
    ...
    distractors: ['ㄘㄨㄥˊ', 'ㄙㄨㄥ'],
    meaning: '在旁鼓動別人做事',
    fun: '朋友慫恿你唸ㄘㄨㄥˊ恿？別聽他的',
    tags: ['易讀錯'], difficulty: 2, era: 'classic'
  },
  {
    id: 'tk-066', text: '蛻變', target: '蛻', zhuyin: 'ㄕㄨㄟˋ',
    distractors: ['ㄊㄨㄟˋ', 'ㄉㄨㄟˋ'],
    meaning: '形體或性質徹底改變',
    fun: '教育部辭典唸ㄕㄨㄟˋ變，全場傻眼。想蛻變，先從這個音開始',
    tags: ['易讀錯'], difficulty: 4, era: 'classic'
  },
  {
  ...
  },
  {
    ...
    distractors: ['ㄒㄩㄝˋ', 'ㄒㄧㄝ'],
    meaning: '輕視、認為不值得',
    fun: '屑唸ㄒㄧㄝˋ。對正確讀音不屑一顧的人，分數也對你不屑一顧',
    tags: ['易讀錯', '日常'], difficulty: 2, era: 'classic'
  },
  {
    id: 'tk-127', text: '邋遢', target: '邋', zhuyin: 'ㄌㄚˊ',
    distractors: ['ㄌㄚ', 'ㄌㄧㄝˋ'],
    meaning: '不整潔、不修邊幅',
    fun: '邋是二聲ㄌㄚˊ。外表可以邋遢，發音請整理一下',
    tags: ['易讀錯', '日常'], difficulty: 2, era: 'modern'
  },
  {
  ...
  {
    id: 'tk-133', text: '字帖', target: '帖', zhuyin: 'ㄊㄧㄝˋ',
    distractors: ['ㄊㄧㄝ', 'ㄊㄧㄝˇ'],
    meaning: '供臨摹的書法範本',
    fun: '字帖ㄊㄧㄝˋ、請帖ㄊㄧㄝˇ、妥帖ㄊㄧㄝ，一個字收集三種聲調',
    tags: ['易讀錯', '破音字'], difficulty: 3, era: 'classic'
  },
  {
